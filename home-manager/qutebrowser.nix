...
in {
  ...
  programs.qutebrowser = {
    ...
    loadAutoconfig = true;
    searchEngines = {
      DEFAULT = "https://start.duckduckgo.com/?ia=web&q={}";
      ddg = "https://start.duckduckgo.com/?ia=web&q={}";
      ddgi = "https://start.duckduckgo.com/?q={}&t=h_&start=1&iar=images&iax=images&ia=images";
    ...
    settings = {
      ...
      editor.command = ["$TERMINAL" "nvim" "-f" "{file}" "-c" "normal {line}G{column0}l"];
    };
    extraConfig =
      /*
      python
    ...
    greasemonkey = let
      ...
      _4chanX = pkgs.fetchurl {
        ...
        hash = "sha256-+a/PTlxeUzZ9JJwcrSc5R4A7w/8mz0aazis2IyuxHNk=";
      };
      control-panel-for-twitter = pkgs.fetchurl {
        ...
        hash = "sha256-Y2JN3fq3/sNraaR8fLNYO8g7kwgOy2sxPxJNYNFTBQ4=";
        postFetch = ''
      ...
      twitter-decensor = pkgs.fetchurl {
        url = "https://raw.githubusercontent.com/TehFridge/Twitter-DeCensor/refs/heads/main/Twitter-DeCensor-Chromium.user.js";
        hash = "sha256-6I3GSvj3J/FMeko07MG9yJn/R9Y01R12ezcDrsazk9U=";
      };
      gelbooru-adb =
